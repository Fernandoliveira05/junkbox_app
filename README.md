...
<div style={{ margin: 25 }}>
  <div style={{ textAlign: "center" }}>
    <img
      src="junkbox_flutter/assets/Logo.png"
      style={{ width: "100%", maxWidth: 1203 }}
      alt="Distância entre dois locais através do Google Maps"
    />
    <br />
  </div>
</div>
...
<div style={{ margin: 25 }}>
  <div style={{ textAlign: "center" }}>
    <img
      src="assets/notificacao_musica.png"
      style={{ width: "100%", maxWidth: 1203 }}
      alt="Imagem da notificação sobre a música encontrada"
    />
    <br />
  </div>
</div>
